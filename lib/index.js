...
var DualDID = /** @class */ (function () {
    ...
    DualDID.prototype.SetRevokeCodeDid = function (did, revokeCode) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var nonce, rawTx, signedTx, receipt, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contract.methods.GetNonceDID(this.dualSigner.ethAccount.address).call()];
                    case 1:
                        nonce = _b.sent();
                        rawTx = {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        nonce = _a.sent();
                        data = this.contract.methods.SetRevokeCodeDID(_did, revokeCode, nonce).encodeABI();
                        return [4 /*yield*/, this.dualSigner.ethAccount.sign(this.web3.utils.sha3(data))];
                    case 2:
                        sign = _a.sent();
                        return [2 /*return*/, { parms: { did: _did, revokeCode: revokeCode, nonce: parseInt(nonce) }, signer: this.dualSigner.ethAccount.address, signature: sign.signature }];
                }
            });
        });
    };
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.post('/rest/metatx', { method: 'SetRevokeCodeVC2', rawTx: rawTx })];
                    case 1:
                        res = _a.sent();
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contract.methods.GetNonceVC(this.dualSigner.ethAccount.address).call()];
                    case 1:
                        nonce = _b.sent();
                        rawTx = {
                            to: this.contract.options.address,
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        nonce = _a.sent();
                        data = this.contract.methods.SetRevokeCodeVC(hashToken, revokeCode, nonce).encodeABI();
                        return [4 /*yield*/, this.dualSigner.ethAccount.sign(this.web3.utils.sha3(data))];
                    case 2:
                        sign = _a.sent();
                        return [2 /*return*/, { parms: { hashToken: hashToken, revokeCode: revokeCode, nonce: parseInt(nonce) }, signer: this.dualSigner.ethAccount.address, signature: sign.signature }];
                }
            });
        });
    };
