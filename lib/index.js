...
var DualDID = /** @class */ (function () {
    ...
    DualDID.prototype.SetRevokeCodeVC = function (hashToken, credentialStatus, revokeCode) {
        if (revokeCode === void 0) { revokeCode = 1; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!credentialStatus || credentialStatus.type !== BLOCKCHAIN) {
                            // TODO: test credentialStatus
                            return [2 /*return*/, { success: true, code: 0 }];
                        }
                        if (!this.web3) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.contract.methods.GetRevokeCodeVC(hashToken, issuer).call()];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
                    ...
                    case 3:
                        result = _a;
                        return [2 /*return*/, { success: true, code: result }];
                    case 4:
                        error_1 = _b.sent();
    ...
    DualDID.prototype.verifyVP = function (vpJwt, nonce) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var resolver, verifiedVP, verify, _i, _a, item, hashToken, credentialStatus, issuer, result;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        item = _a[_i];
                        if (!(item.credentialSubject && item.credentialSubject.id)) return [3 /*break*/, 4];
                    ...
                    case 3:
                        result = _b.sent();
                        verify && (verify = result.success && result.code === '0');
                        _b.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, verify ? verifiedVP : null];
                }
            });
        });
    };
